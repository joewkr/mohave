...
foreign import ccall safe "nc_close" c_nc_close :: CInt -> IO CInt
-- int     nc_close_memio (int ncid, NC_memio *memio)
foreign import ccall safe "nc_create" c_nc_create :: CString -> CInt -> Ptr CInt -> IO CInt
...
foreign import ccall safe "nc_enddef" c_nc_enddef :: CInt -> IO CInt
foreign import ccall safe "nc_inq" c_nc_inq :: CInt -> Ptr CInt -> Ptr CInt -> Ptr CInt -> Ptr CInt -> IO CInt
foreign import ccall safe "nc_inq_format" c_nc_inq_format :: CInt -> Ptr CInt -> IO CInt
foreign import ccall safe "nc_inq_format_extended" c_nc_inq_format_extended :: CInt -> Ptr CInt -> Ptr CInt -> IO CInt
foreign import ccall safe "nc_inq_path" c_nc_inq_path :: CInt -> Ptr CSize -> CString -> IO CInt
-- int     nc_inq_type (int ncid, nc_type xtype, char *name, size_t *size)
-- int     nc_inq_user_format -- no user-defined format support in this version of Haskell bindings
foreign import ccall safe "nc_open" c_nc_open :: CString -> CInt -> Ptr CInt -> IO CInt
...
foreign import ccall safe "nc_redef" c_nc_redef :: CInt -> IO CInt
foreign import ccall safe "nc_set_fill" c_nc_set_fill :: CInt -> CInt -> Ptr CInt -> IO CInt
